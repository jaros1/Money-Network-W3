    ...
    .factory('MoneyNetworkW3Service', ['$timeout', '$rootScope', '$window', '$location', 'btcService', 'brFilter',
        function ($timeout, $rootScope, $window, $location, btcService, br) {
            ...
            function get_my_wallet_hub (cb) {
                ...
                // step 1 : get a list of W3 wallet data hubs. title or description matches /w2 /i. used for new W3 users
                    ...
                    if (error) response.error = 'message is invalid. ' + error;
                        ...
                        (function request_wallet_backup(){
                            ...
                            step_1_confirm = function() {
                                ...
                                report_error(pgm, 'Please confirm backup request in W3', {log: false, w2: false, type:'info', timeout: 10000}) ;
                        ...
                        (function restore_wallet_backup() {
                            ...
                            step_1_confirm = function() {
                                ...
                                // 2: notification in MN session. xxx
                                report_error(pgm, 'Please confirm backup restore in W3', {log: false, w2: false, type:'info', timeout: 10000}) ;
